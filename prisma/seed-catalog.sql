...
-- Clear existing data
DELETE FROM "catalog_video_lessons";
DELETE FROM "catalog_skills";
DELETE FROM "catalog_courses";
DELETE FROM "catalog_question_banks";
DELETE FROM "catalog_sim_tests";
...
('pkg_qudrat_1', 'QUDRAT', 'الباقة الشاملة (قدرات)', 'أفضل باقة للتفوق في القدرات', 399, 550, '["كمي + لفظي كاملين", "بنك أسئلة شامل", "15 اختبار محاكي", "حصص مباشرة"]', true, 'bg-gradient-to-br from-blue-500 to-indigo-600', 1, NOW(), NOW()),
('pkg_qudrat_2', 'QUDRAT', 'باقة الكمي', 'تركيز على القسم الكمي', 249, 350, '["دورة كمي كاملة", "بنك 850 سؤال", "8 اختبارات محاكية"]', false, 'bg-gradient-to-br from-purple-500 to-pink-600', 2, NOW(), NOW()),
('pkg_qudrat_3', 'QUDRAT', 'باقة المحاكي', 'للتدريب المكثف', 99, 150, '["20 اختبار محاكي", "تحليل نقاط الضعف بالذكاء الاصطناعي"]', false, 'bg-gradient-to-br from-emerald-500 to-teal-600', 3, NOW(), NOW()),
('pkg_tahsili_1', 'TAHSILI', 'الباقة الشاملة (تحصيلي)', 'جميع المواد في باقة واحدة', 499, 650, '["جميع المواد (رياضيات، فيزياء، كيمياء، أحياء)", "بنك أسئلة شامل", "تجميعات 5 سنوات", "حصص مباشرة أسبوعية"]', true, 'bg-gradient-to-br from-emerald-600 to-cyan-600', 1, NOW(), NOW()),
...
('pkg_tahsili_3', 'TAHSILI', 'باقة المراجعة النهائية', 'للتحضير السريع', 150, 200, '["ملخصات مكثفة", "أهم 500 سؤال", "اختبار تجريبي شامل"]', false, 'bg-gradient-to-br from-cyan-500 to-blue-600', 3, NOW(), NOW());
